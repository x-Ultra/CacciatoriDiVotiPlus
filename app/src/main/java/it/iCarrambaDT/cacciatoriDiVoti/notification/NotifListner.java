...
public class NotifListner extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        SharedPreferences shared2 = context.getSharedPreferences("laurea", MODE_PRIVATE);
        SharedManager manager2 = new SharedManager(shared2);

        String degree = manager.getLaurea();

        //contatto il server
            //materia = ServerCaller.getInstance().getVotoFromServer(DEGREE);
